...
def create_parser():
    ...
    arg_parser.add_argument('-d', '--dir', type=str, default='../',
                            help='specify the push_swap directory (not work with -g)')
    ...
    arg_parser.add_argument('-n', '--n_iter', type=int, default=10,
                            help='specify the number of iterations to test the 100 and 500 sets')
    arg_parser.add_argument('-v', '--verbose', action='store_true', default=False,
                            help='print the list of numbers used for the test')
    arg_parser.add_argument("--test", type=str, default="a",
                            help="allows you to do a specific test (a = all, e = error, i = identity, s = simple, o = 100, f = 500)")
